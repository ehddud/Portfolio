(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      ...
      strokeStyle: "#978e71",          // the color of the stroke
      strokeWidth: 8,          // the stroke width, dynamically calulated if omitted in options
      fillStyle: "#ea9c5e",            // the fill color
      fontColor: "white",            // the font color
      fontFamily: "Noto-sans",        // the font family
